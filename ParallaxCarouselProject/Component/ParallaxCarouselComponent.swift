//
//  ParallaxCarouselComponent.swift
...
struct ParallaxCarouselView: View {
                    ...
                    ScrollView(.horizontal) {
                        HStack(spacing: 5) {
                            ForEach(CardModel.cards) { card in
                                ...
                                .frame(
                                    width: size.width - 2*horizontalPadding - 2*paddingConstant,
                                    height: size.height - horizontalPadding
                                )
                                .scrollTransition(
                                    .interactive,
                                    axis: .horizontal
    ...
    @ViewBuilder
    private func titleOverlayForCard(_ card: CardModel) -> some View {
